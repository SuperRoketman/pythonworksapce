...
# print(os.listdir("E:\\githubdesktop-SuperRoketman\\pythonworkspace\\rpa_basic")) # 주어진 폴더 밑에서 모든 폴더, 파일 목록 가져오기
...
# 주어진 경로가 파일인지? 폴더인지?
# print(os.path.isdir("E:\\githubdesktop-SuperRoketman\\pythonworkspace\\rpa_basic")) # rpa_basic 은 폴더인가?
# print(os.path.isfile("E:\\githubdesktop-SuperRoketman\\pythonworkspace\\rpa_basic")) # rpa_basic 은 파일인가?

# print(os.path.isdir("run_btn.png"))
# print(os.path.isfile("run_btn.png"))

# # 만약 지정된 경로에 해당하는 파일 / 폴더가 없다면?
# print(os.path.isfile("asdf.asdf")) # 무조건 False 반환

# 주어진 경로가 존재하는지?
# if os.path.exists("pythonworkspace/rpa_basic"):
...
# 파일명 변경
# os.rename("new_file.txt", "new_file_rename.txt") # 앞의 것을 뒤의 것으로 변경
...
# 폴더 만들기
# os.mkdir("new_folder")
# os.mkdir("e:/githubdesktop-SuperRoketman/pythonworkspace/rpa_basic/test") # 절대경로 기준으로 폴더 생성
...
# shutil.move("test_folder2", "test_folder") # 해당되는 폴더가 없을 시 폴더명이 변경되는 효과
