...
# 화면 타이틀 설정
pygame.display.set_caption("Rocketman_Game:Pang")
...
curruent_path = os.path.dirname(__file__) # 현재 파일의 위치 반환
image_path = os.path.join(curruent_path, "images") # images 폴더 위치 반환
...
while running:
    ...
    # 공 위치 정의
    for ball_idx, ball_val in enumerate(balls): #이누머레이트 : 인덱스 값이랑 같이 저장
